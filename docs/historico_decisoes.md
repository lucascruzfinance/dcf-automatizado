# Histórico de decisões da IA (arquivo morto — D-001 a D-079)

> 📦 **ARQUIVO HISTÓRICO, criado em 22/07/2026.** Este era o `Humano_revisar.md`
> (1.520 linhas) até ser enxugado a pedido de Lucas. Tudo aqui já foi executado e
> estabilizado; nenhuma entrada exige mais uma escolha dele. As decisões que
> **ainda dependem de Lucas** vivem em [`../Humano_revisar.md`](../Humano_revisar.md)
> (itens A-1 a A-7), que aponta o D-nnn de origem de cada uma.
>
> Use este arquivo só para consulta: "por que essa escolha foi feita?".
